...
import StatsComponent from "../components/core/AboutPage/StatsComponent.jsx";
        ...
        <div>
            ...
            <section className="bg-richblack-700">
                <div className="relative mx-auto flex w-11/12 max-w-maxContent flex-col justify-between gap-10 text-center text-white">
                    <header className="mx-auto py-20 text-4xl font-semibold lg:w-[70%]" >Driving Inovation in Online Education for a
            ...
            {/* Section3 */}
            <section>
                <div className='mx-auto flex w-11/12 max-w-maxContent flex-col justiy-between gap-10 text-richblack-500'>
